...
public class BaseTest {
	...
	public ExtentReports reports = Extentreports.getReports();
	...
	//**********************VerifyMessage*************************//
	public void verifymessage(String locatorKey,String message) {
	...
	public String verifyTitle(String title){
		//String PageTitle = driver.findElement(By.xpath("//*[@id='main']/h1")).getText();
		String PageTitle=getElement("title_xpath").getText();
		if(PageTitle.contains(prop.getProperty(title))) {
			reportPass("Page header is verified:"+ PageTitle);
		}
		return PageTitle;
	}
